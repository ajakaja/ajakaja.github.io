...
(function (root, factory) {
    ...
    $.inlineFootnotes = function( options ) {
        ...
        $('sup[id^="' + opts['footNoteRefID'] + '"]').each(function(i) {
            ...
            // REMOVED: this is doing something wrong and putting things at the top of the screen.
...
*/
    ...
    $.inlineFootnotes.defaults = {
        columnWidth: 800, // minimum width of the screen necessary to display footnotes
        mediaQuery: null, // copy & paste the media query from your CSS file, if you prefer (and have polyfilled window.matchMedia)
        overlapOffset: 50, // padding (in pixels) between overlapping footnotes
