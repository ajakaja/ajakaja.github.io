(function (factory) {
    ...
    $.inlineFootnotes.defaults = {
        columnWidth: 1000, // minimum width of the screen necessary to display footnotes
        mediaQuery: null, // copy & paste the media query from your CSS file, if you prefer (and have polyfilled window.matchMedia)
        overlapOffset: 200, // padding (in pixels) between overlapping footnotes
        ...
        maxCollisionCycles: 15, // Number of iterations of collision detection to run, may need to increase.
