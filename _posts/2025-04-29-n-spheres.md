...
By the way, I am probably not going to always use the word "sphere" and "ball" correctly in here. I like to just say they're the area and volume of the same object, the $$n$$-sphere, rather than calling the interior a ball instead. After all that is what the word 'sphere' means colloquially. To be technically accurate, though, I am talking about the $$(n-1)$$-volumes of the $$(n-1)$$-spheres, and the associated $$n$$-volumes of their interiors, the $$n$$-balls. I'll try to use them right but, no promises.
