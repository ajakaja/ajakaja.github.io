...
The way we solved $$A \b{x} = \b{b}$$ in projective coordinates for matrices can give us intuition inverting differential operators also like $$D f = g$$.

Consisder how differential equations' inverses produce degrees of freedom in their solutions. This is not something I know at any particular theoretical level, but over the years I've picked up a sense of it. For starters, obviously $$N$$th-order differential equation can end up with $$N$$ integration constants:
