...
Where $$\varpi$$ is the [lemniscate constant](https://en.wikipedia.org/wiki/Lemniscate_constant). ($$2 \varpi$$ being the perimeter of Bernoulli's lemniscate, $$(x^2 + y^2)^2 = x^2 - y^2$$, similar to $$2 \pi$$ being the perimeter of a circle; we are only interested in the constant, though, not the shape.) Perhaps it could also simplify some of the nightmarish expressions that are known for other values of $$\Gamma$$, such as
