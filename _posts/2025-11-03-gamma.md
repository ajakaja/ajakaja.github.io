...
Now suppose we are thinking of the same tetrahedron as "actually" being a $$6$$-ball, whatever that means. We regard $$x+ y + z < a$$ as describing the relationship between the _areas_ of three circles with radii $$(r_x, r_y, r_z)$$, whose overall area is constrained to be less than $$\pi R^2$$
