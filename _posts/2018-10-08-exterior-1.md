...
I happen to think it deserves to be _far_ more commonplace, because it turns out to take a lot of the mysteriousness out of the otherwise technical and tedious subject of linear algebra, and it turns out to be used in disguise all over the place.
...
* If $$U=V$$ then $$A^{\^ n - 1}$$ is (almost) the _adjugate_ of $$A$$, except that it is written in the $$\^^{n-1} V$$ basis.
