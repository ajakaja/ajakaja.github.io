...
See the Wiki on [shift operators](https://en.wikipedia.org/wiki/Shift_operator) for more examples.[^qm]. We can also take logarithms in the same framework. Using the approximation $$\log (1+x) \approx x$$:
